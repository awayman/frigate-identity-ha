...
- [Overview](#overview)
- [Part 1 – Automatic Dashboard Generation](#part-1--automatic-dashboard-generation)
  - [Configuration Options](#configuration-options)
  - [Manual Dashboard Regeneration](#manual-dashboard-regeneration)
  - [Troubleshooting Autogenerated Dashboard](#troubleshooting-autogenerated-dashboard)
  - [Snapshot History](#snapshot-history)
  - [Viewing Snapshot History in a Dashboard Card](#viewing-snapshot-history-in-a-dashboard-card)
  - [Snapshot Source Options](#snapshot-source-options)
- [Part 2 – Person Profile Configuration](#part-2--person-profile-configuration)
  - [Configuring Children and Safe Zones](#configuring-children-and-safe-zones)
  - [Zone Model for Multi-Camera Supervision](#zone-model-for-multi-camera-supervision)
  - [Level 1 – Frigate Camera Zones (Safe Zone Configuration)](#level-1--frigate-camera-zones-safe-zone-configuration)
  - [Level 2 – HA Areas (Cross-Camera Supervision)](#level-2--ha-areas-cross-camera-supervision)
  - [Assigning Cameras to HA Areas](#assigning-cameras-to-ha-areas)
  - [Complete Configuration Example](#complete-configuration-example)
- [Part 3 – Available Blueprints](#part-3--available-blueprints)
- [Part 4 – Recommended Setup Sequence](#part-4--recommended-setup-sequence)
- [Part 5 – Automatic Updates (Built-In)](#part-5--automatic-updates-built-in)
...
| `dashboard_name` | `Kids` | Sidebar title for `/lovelace/frigate-identity` |
...
Step 7  🔲  (Optional) Use the `switch.frigate_identity_manual_supervision` override when needed
...
| New person detected | Entity creation + dashboard refresh (10s debounce) |
| Camera Area changed | Dashboard re-grouped automatically (10s debounce) |
...
3. Integration creates entities:
   ...
   - camera.frigate_identity_carol_snapshot
       ↓
4. Dashboard automatically refreshed (10s debounce)
       ↓
...
2. Integration detects area_registry_updated event
       ↓
3. Dashboard regenerated with new area grouping (10s debounce)
       ↓
