...
### Changed
- dashboard: update card type to custom:stack-in-card and adjust tests accordingly
## [0.6.1] - 2026-04-08

### Added
- dashboard: implement person ordering and enhance dashboard generation
## [0.6.0] - 2026-04-04
...
### Added
- debug: publish health debug messages when disconnected
### Fixed
- integration: remove automatic Supervisor add-on restart
## [0.5.31] - 2026-03-22
...
### Added
- service: add clear_embeddings service to reset learned person embeddings
## [0.5.28] - 2026-03-21
